 ...
 * Version 2.1 (Nightly: dab3746) (2015-03-28)
 * http://elfinder.org
 * 
 ...
 * @type String
 **/
elFinder.prototype.version = '2.1 (Nightly: dab3746)';
...
$.fn.elfindernavbar = function(fm, opts) {
	...
	var list = $("<dl class='elfinder-navbar-list'><dt>附件清单:</dt></dl>");
	for(var i=0;i<opts.navList.length;i++){
		list.append("<dd>"+opts.navList[i]+"</dd>");
	}
	this.append(list);
	return this;
};
...
elFinder.prototype.commands.help = function() {
	var fm   = this.fm,
		...
		about = function() {
			...
			html.push(atpl[r](author, fm.i18[fm.lang].translator)[r](work, fm.i18n('maintainer')));
		...
		help = function() {
			...
			html.push('<p>1:点击工具栏的绿色加号磁盘图标，上传附件，上传附件可以同时选取多个文件。</p>');
			html.push('<p>2:鼠标右击文件名，可以弹出操作菜单，在菜单中可以找到文件重命名、下载、删除等操作按钮。</p>');
			html.push('<p>3:工具栏的各种操作按钮，如果不清楚按钮的功能，可以鼠标指针放置在按钮上方，等待一秒左右会有操作提示。</p>');
			html.push('<p>4:附件清单列出了当前项目必须的所有附件。请确保附件列表中已经上传了清单中所有的附件。</p>');
			html.push('<p>5:附件的文件名请使用具有一定意义的中文名字，例如 ‘主管部门意见扫描件.jpg’,不要使用无意义的文件名例如 ‘435345.jpg’。</p>');
			html.push('<p>6:文件名最后一个‘.’(点)以及后面英文字符为附件的后缀名，修改文件名的时候不要修改文件后缀名。例如图片文件的后缀可以是‘.jpg’。</p>');
			html.push('</div>');
			// end help
		},
		content = '';
